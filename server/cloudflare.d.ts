/* eslint-disable */
// Generated by Wrangler by running `wrangler types server/cloudflare.d.ts` (hash: c541620a6948690683bae451a1ce7a35)
// Runtime types generated with workerd@1.20251210.0 2025-04-03 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./index');
  }
  interface Env {
    TOKEN_EXPIRE_DAYS: 30 | 4;
    TOKEN_COOKIE_NAME: 'token' | '__Host-Http-token' | '__Host-token';
    EMAIL_SENDER_NAME: 'PreProd-Perfin' | 'Perfin' | 'Perfin-Staging';
    EMAIL_SENDER_ADDR: 'no-reply@perfin.acidmyke.link' | 'no-reply@perfin-staging.acidmyke.link';
    ORIGIN: 'http://localhost:5173' | 'https://perfin.acidmyke.link' | 'https://perfin-staging.acidmyke.link';
    PASSKEYS_RP_NAME: 'Perfin';
    PASSKEYS_RP_ID: 'localhost' | 'perfin.acidmyke.link' | 'perfin-staging.acidmyke.link';
