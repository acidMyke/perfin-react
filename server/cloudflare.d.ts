/* eslint-disable */
// Generated by Wrangler by running `wrangler types server/cloudflare.d.ts` (hash: 9bf63a8c5ac9d5ef9a069fe86e3b1aa7)
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'TOKEN_COOKIE_NAME' | 'EMAIL_SENDER_NAME' | 'EMAIL_SENDER_ADDR' | 'MJ_APIKEY_PUBLIC' | 'MJ_APIKEY_PRIVATE'
      >
    > {}
}
