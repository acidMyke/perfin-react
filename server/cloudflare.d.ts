/* eslint-disable */
// Generated by Wrangler by running `wrangler types server/cloudflare.d.ts` (hash: f1756ba967c9f216f63b167aeb0274a2)
// Runtime types generated with workerd@1.20260409.1 2025-04-03 nodejs_compat
declare namespace Cloudflare {
  ...
  interface ProductionEnv {
    db: D1Database;
    TOKEN_EXPIRE_DAYS: 4;
    TOKEN_COOKIE_NAME: '__Host-Http-token';
    EMAIL_SENDER_NAME: 'Perfin';
    EMAIL_SENDER_ADDR: 'no-reply@perfin.acidmyke.link';
    ORIGIN: 'https://perfin.acidmyke.link';
    PASSKEYS_RP_NAME: 'Perfin';
    PASSKEYS_RP_ID: 'perfin.acidmyke.link';
    ALLOW_SIGNUP: 'false';
    REINDEXER_SLEEP: '8 hours';
    VAPID_SUBJECT: 'mailto:perfin-owner@acidmyke.link';
    ...
    V2_MIGRATOR: Workflow<Parameters<import('./index').VersionTwoDataMigrator['run']>[0]['payload']>;
    EXPENSE_REINDEXER: Workflow<Parameters<import('./index').UserExpenseReindexer['run']>[0]['payload']>;
  }
  interface StagingEnv {
    db: D1Database;
    TOKEN_EXPIRE_DAYS: 4;
    TOKEN_COOKIE_NAME: '__Host-token';
    EMAIL_SENDER_NAME: 'Perfin-Staging';
    EMAIL_SENDER_ADDR: 'no-reply@perfin-staging.acidmyke.link';
    ORIGIN: 'https://perfin-staging.acidmyke.link';
    PASSKEYS_RP_NAME: 'Perfin';
    PASSKEYS_RP_ID: 'perfin-staging.acidmyke.link';
    ALLOW_SIGNUP: 'true';
    REINDEXER_SLEEP: '8 hours';
    VAPID_SUBJECT: 'mailto:perfin-owner@acidmyke.link';
    MJ_APIKEY_PUBLIC: string;
  ...
  interface Env {
    db: D1Database;
    TOKEN_EXPIRE_DAYS: 4 | 30;
    TOKEN_COOKIE_NAME: '__Host-Http-token' | '__Host-token' | 'token';
    EMAIL_SENDER_NAME: 'Perfin' | 'Perfin-Staging' | 'PreProd-Perfin';
    EMAIL_SENDER_ADDR: 'no-reply@perfin.acidmyke.link' | 'no-reply@perfin-staging.acidmyke.link';
    ORIGIN: 'https://perfin.acidmyke.link' | 'https://perfin-staging.acidmyke.link' | 'http://localhost:5173';
    PASSKEYS_RP_NAME: 'Perfin';
    PASSKEYS_RP_ID: 'perfin.acidmyke.link' | 'perfin-staging.acidmyke.link' | 'localhost';
    ALLOW_SIGNUP: 'false' | 'true';
    REINDEXER_SLEEP: '8 hours' | '20 seconds';
    VAPID_SUBJECT: 'mailto:perfin-owner@acidmyke.link';
    MJ_APIKEY_PUBLIC: string;
    MJ_APIKEY_PRIVATE: string;
    CF_ACCOUNT_ID: string;
