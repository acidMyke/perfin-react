/* eslint-disable */
// Generated by Wrangler by running `wrangler types server/cloudflare.d.ts` (hash: d85cf2ab46840243bdec8845fee97591)
...
declare namespace Cloudflare {
  ...
  interface Env {
    TOKEN_COOKIE_NAME: 'token' | '__Host-token';
    EMAIL_SENDER_NAME: 'PreProd-Pefin' | 'Pefin';
    EMAIL_SENDER_ADDR: 'no-reply@perfin.acidmyke.link';
    ORIGIN: 'http://localhost:5173' | 'https://perfin.acidmyke.link';
    PASSKEYS_RP_NAME: 'Perfin';
    PASSKEYS_RP_ID: 'localhost' | 'perfin.acidmyke.link';
